...
class SolverBase:
    ...
    def isSolvable(self):
        ...
        twin_solver = Solver(twin_board, self.use_manhattan)
...
def board_gen(n):
    # Генерация доски: Никифоров Андрей
    values = [_ for _ in range(n ** 2)]
...
if __name__ == "__main__":
  print("Размер n*n:")
  n = int(input())
  # Пример чтения доски из файла:
  initial_board = Board(board_gen(n))

  print("Исходная доска:")
  print(initial_board)

  solver = Solver(initial_board, use_manhattan=True)
